...
mixin _$GetMovieDetailDto {
  ...
  List<MovieDetailResult>? get movieDetailResults =>
...
abstract class $GetMovieDetailDtoCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: "results") List<MovieDetailResult>? movieDetailResults});
}
...
class _$GetMovieDetailDtoCopyWithImpl<$Res, $Val extends GetMovieDetailDto>
  ...
  $Res call({
    Object? id = freezed,
    Object? movieDetailResults = freezed,
  }) {
    return _then(_value.copyWith(
      id: freezed == id
          ...
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
      movieDetailResults: freezed == movieDetailResults
          ? _value.movieDetailResults
          : movieDetailResults // ignore: cast_nullable_to_non_nullable
...
class _$GetMovieDetailDtoImpl implements _GetMovieDetailDto {
  const _$GetMovieDetailDtoImpl(
      ...
      @JsonKey(name: "results")
      final List<MovieDetailResult>? movieDetailResults})
      : _movieDetailResults = movieDetailResults;
  ...
  @JsonKey(name: "id")
  final int? id;
  final List<MovieDetailResult>? _movieDetailResults;
  @override
  @JsonKey(name: "results")
  List<MovieDetailResult>? get movieDetailResults {
    final value = _movieDetailResults;
    if (value == null) return null;
    if (_movieDetailResults is EqualUnmodifiableListView)
      return _movieDetailResults;
  ...
  @override
  String toString() {
    return 'GetMovieDetailDto(id: $id, movieDetailResults: $movieDetailResults)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._movieDetailResults, _movieDetailResults));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id,
      const DeepCollectionEquality().hash(_movieDetailResults));
