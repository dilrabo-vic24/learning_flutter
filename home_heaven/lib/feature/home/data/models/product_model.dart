...
class ProductModel {
    ...
    @JsonKey(name: "ProductPagination")
    final ProductPagination? productPagination;
...
class ProductPagination {
    ...
    factory ProductPagination.fromJson(Map<String, dynamic> json) => _$ProductPaginationFromJson(json);
