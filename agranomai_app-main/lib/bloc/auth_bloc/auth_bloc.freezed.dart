...
class _$SignInImpl implements _SignIn {
  const _$SignInImpl({required this.phoneNumber, required this.password});
  ...
  @override
  String toString() {
    return 'AuthEvent.signIn(phoneNumber: $phoneNumber, password: $password)';
  }
...
class _$SignUpImpl implements _SignUp {
  const _$SignUpImpl({required this.phoneNumber, required this.password});
  ...
  @override
  String toString() {
    return 'AuthEvent.signUp(phoneNumber: $phoneNumber, password: $password)';
  }
